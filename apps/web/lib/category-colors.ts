...
const CATEGORY_COLOR_MAP: Record<string, [bg: string, text: string, hex: string]> = {
  ...
  교통: ['bg-green-100', 'text-green-700', '#22c55e'],
  통신: ['bg-purple-100', 'text-purple-700', '#a855f7'],
  월세: ['bg-orange-100', 'text-orange-700', '#f97316'],
  생활: ['bg-cyan-100', 'text-cyan-700', '#06b6d4'],
  경조: ['bg-pink-100', 'text-pink-700', '#ec4899'],
  문화: ['bg-indigo-100', 'text-indigo-700', '#6366f1'],
  공과금: ['bg-amber-100', 'text-amber-700', '#f59e0b'],
  // SAVING
  보험: ['bg-emerald-100', 'text-emerald-700', '#10b981'],
  청약: ['bg-teal-100', 'text-teal-700', '#14b8a6'],
  연금: ['bg-sky-100', 'text-sky-700', '#0ea5e9'],
